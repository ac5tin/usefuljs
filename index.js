...
/** Number extractor from string e.g. "1.8K Users"
  * @param { string } value
  * @returns { number }
  */
const numXt = value =>{
    let f = 0; // first int index
    let l = value.length[value.length - 1];// last int index
}
...
module.exports = {
    ...
    arrobj2obj,f_obj,hexCode,toCSV,toCSV
}
